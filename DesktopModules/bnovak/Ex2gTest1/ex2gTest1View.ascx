<%@ Control Language="VB" AutoEventWireup="false" Inherits="bnovak.Ex2gTest1.ex2gTest1View" CodeFile="ex2gTest1View.ascx.vb" %>
...
<div class="dnnForm dnnEdit dnnClear" id="dnnEdit">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            <dnn:label id="plAddress" runat="server" text="Address" helptext="Enter your street address." controlname="AddressTextbox" />
        ...
        <div class="dnnFormItem">
            <dnn:label id="plZip" runat="server" text="Zip Code" helptext="Enter your zip code." controlname="ZipTextbox" />
            <asp:textbox id="ZipTextbox" runat="server" maxlength="12" />
        </div>
        <div class="dnnFormItem">
